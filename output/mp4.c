...
static int close_file( hnd_t handle, int64_t largest_pts, int64_t second_largest_pts )
{
    ...
    if( p_mp4->p_root && p_mp4->i_track )
    {
         ...
         */
        uint32_t mvhd_timescale = lsmash_get_movie_timescale( p_mp4->p_root );
...
static int set_param( hnd_t handle, x264_param_t *p_param )
{
    ...
    MP4_FAIL_IF_ERR( lsmash_set_track_presentation_size( p_mp4->p_root, p_mp4->i_track, i_display_width, i_display_height ),
